...
<?php else : ?>
	...
	<?php // LCGF: stato vuoto brandizzato con CTA al catalogo (al posto della notice standard). ?>
	<div class="lcgf-no-orders">
		<div class="lcgf-no-orders__ico" aria-hidden="true">
		...
		<h3 class="lcgf-no-orders__title"><?php esc_html_e( 'Non hai ancora effettuato ordini', 'woocommerce' ); ?></h3>
		<p class="lcgf-no-orders__text"><?php esc_html_e( 'Quando effettuerai il tuo primo ordine, lo troverai qui con tutti i dettagli e lo stato di avanzamento.', 'woocommerce' ); ?></p>
		<a class="lcgf-no-orders__cta" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php esc_html_e( 'Sfoglia il catalogo', 'woocommerce' ); ?></a>
	</div>
